...
class FakeResponseData {
    ...
    static let weatherResponseKO = HTTPURLResponse(url: URL(string: "https://api.openweathermap.org")!, statusCode: 500, httpVersion: nil, headerFields: nil)
    ...
    static let changeResponseKO = HTTPURLResponse(url: URL(string: "https://api.apilayer.com")!, statusCode: 500, httpVersion: nil, headerFields: nil)
